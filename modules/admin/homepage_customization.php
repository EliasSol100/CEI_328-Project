      ...
      <form method="POST" enctype="multipart/form-data" class="homepage-customization-form">
        ...
        <div class="card mb-6">
          <div class="homepage-size-header">
            ...
            <p class="text-sm text-muted">Uploads still follow the same exact sizes, but the editing flow is now split into smaller sections.</p>
          </div>
            ...
            <div class="homepage-upload-grid homepage-upload-grid-single">
              ...
              <div class="homepage-config-card homepage-config-card-simple">
                <div class="form-group">
                  ...
                  <div class="form-hint">Best fit: 1920x600 px. Keep important text/logo inside the centered 1172x600 safe area. Legacy 1172x600 banners are expanded automatically.</div>
                </div>
              </div>
            </div>
          </div>
