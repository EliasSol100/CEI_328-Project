...
$targetLogoRelative = 'uploads/assets/images/homepage/header-logo.png';
...
if (is_file($sourceLogo)) {
    if (!@copy($sourceLogo, $targetLogoAbsolute)) {
        throw new RuntimeException('Could not restore the homepage header logo file.');
    }
}

$homepageConfig = [
    'homepage_hero_image' => 'uploads/assets/images/homepage/hero-section.png',
    'homepage_collection_1_image' => 'uploads/assets/images/homepage/shop-collection-1.png',
    'homepage_collection_1_label' => 'Antipilling Plushies',
    'homepage_collection_1_link' => 'shop.php?category=Animals',
    'homepage_collection_2_image' => 'uploads/assets/images/homepage/shop-collection-2.png',
    'homepage_collection_2_label' => 'Cozy Blankets',
    'homepage_collection_2_link' => 'shop.php?category=Blankets',
    'homepage_collection_3_image' => 'uploads/assets/images/homepage/shop-collection-3.png',
    'homepage_collection_3_label' => 'Character Figures',
    'homepage_collection_3_link' => 'shop.php?category=Dolls',
    'homepage_collection_4_image' => 'uploads/assets/images/homepage/shop-collection-4.png',
    'homepage_collection_4_label' => 'Velvet Plushies',
    'homepage_collection_4_link' => 'shop.php?q=velvet',
    'homepage_journey_1_image' => 'uploads/assets/images/homepage/follow-journey-1.png',
    'homepage_journey_2_image' => 'uploads/assets/images/homepage/follow-journey-2.png',
    'homepage_journey_3_image' => 'uploads/assets/images/homepage/follow-journey-3.png',
];
