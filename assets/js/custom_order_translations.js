(function () {
    ...
    var customOrderTranslations = {
        en: {
            ...
            customOrderReferencePhotoHelp: 'Optional. Uploaded PNG, JPG, or GIF files are converted to webp automatically.',
        ...
        el: {
            ...
            customOrderReferencePhotoHelp: 'Προαιρετικό. Τα αρχεία PNG, JPG ή GIF μετατρέπονται αυτόματα σε webp.',
